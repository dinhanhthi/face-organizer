...
### Changed
- GitHub Actions workflow now runs on Node.js 24 ([48004d9](https://github.com/dinhanhthi/face-organizer/commit/48004d9))

## [0.4.1] - 2026-05-02

### Changed
- Rebranded package from `face-organizer` to `face-grouper` ([40bb742](https://github.com/dinhanhthi/face-organizer/commit/40bb742))
